...
int main(int argc, char *argv[])
{
  ...
  // Init Columns
  mcolumns[COL_SYMBOL] = true;
  vcolumns.push_back(COL_SYMBOL);
  mcolumns[COL_SYMBOL_NAME] = true;
  vcolumns.push_back(COL_SYMBOL_NAME);
  mcolumns[COL_CLOSE] = true;
  vcolumns.push_back(COL_CLOSE);
  mcolumns[COL_PERCENT] = true;
  vcolumns.push_back(COL_PERCENT);
  mcolumns[COL_VOLUME] = true;
  vcolumns.push_back(COL_VOLUME);
  mcolumns[COL_BID_PRICE] = true;
  vcolumns.push_back(COL_BID_PRICE);
  mcolumns[COL_BID_VOLUME] = true;
  vcolumns.push_back(COL_BID_VOLUME);
  mcolumns[COL_ASK_PRICE] = true;
  vcolumns.push_back(COL_ASK_PRICE);
  mcolumns[COL_ASK_VOLUME] = true;
  vcolumns.push_back(COL_ASK_VOLUME);
  mcolumns[COL_UpperLimitPrice] = true;
  vcolumns.push_back(COL_UpperLimitPrice);
  mcolumns[COL_LowerLimitPrice] = true;
  vcolumns.push_back(COL_LowerLimitPrice);
  mcolumns[COL_PREV_SETTLEMENT] = true;
  vcolumns.push_back(COL_PREV_SETTLEMENT);
  mcolumns[COL_ADVANCE] = true;
  vcolumns.push_back(COL_ADVANCE);
  mcolumns[COL_OPEN] = true;
  vcolumns.push_back(COL_OPEN);
  mcolumns[COL_HIGH] = true;
  vcolumns.push_back(COL_HIGH);
  mcolumns[COL_LOW] = true;
  vcolumns.push_back(COL_LOW);
  mcolumns[COL_AVERAGE_PRICE] = true;
  vcolumns.push_back(COL_AVERAGE_PRICE);
  mcolumns[COL_PREV_CLOSE] = true;
  vcolumns.push_back(COL_PREV_CLOSE);
  mcolumns[COL_OPENINT] = true;
  vcolumns.push_back(COL_OPENINT);
  mcolumns[COL_PREV_OPENINT] = true;
  vcolumns.push_back(COL_PREV_OPENINT);
  mcolumns[COL_SETTLEMENT] = true;
  vcolumns.push_back(COL_SETTLEMENT);
  mcolumns[COL_DATE] = true;
  vcolumns.push_back(COL_DATE);
  mcolumns[COL_TIME] = true;
  vcolumns.push_back(COL_TIME);
  mcolumns[COL_EXCHANGE] = true;
  vcolumns.push_back(COL_EXCHANGE);
  mcolumns[COL_TRADE_DAY] = true;
  vcolumns.push_back(COL_TRADE_DAY);

  // Init Order List Columns
  morderlist_columns[ORDERLIST_COL_ACC_ID] = true;
  vorderlist_columns.push_back(ORDERLIST_COL_ACC_ID);
  morderlist_columns[ORDERLIST_COL_SYMBOL] = true;
  vorderlist_columns.push_back(ORDERLIST_COL_SYMBOL);
  morderlist_columns[ORDERLIST_COL_SYMBOL_NAME] = true;
  vorderlist_columns.push_back(ORDERLIST_COL_SYMBOL_NAME);
  morderlist_columns[ORDERLIST_COL_DIRECTION] = true;
  vorderlist_columns.push_back(ORDERLIST_COL_DIRECTION);
  morderlist_columns[ORDERLIST_COL_VOLUME] = true;
  vorderlist_columns.push_back(ORDERLIST_COL_VOLUME);
  morderlist_columns[ORDERLIST_COL_VOLUME_FILLED] = true;
  vorderlist_columns.push_back(ORDERLIST_COL_VOLUME_FILLED);
  morderlist_columns[ORDERLIST_COL_PRICE] = true;
  vorderlist_columns.push_back(ORDERLIST_COL_PRICE);
  morderlist_columns[ORDERLIST_COL_AVG_PRICE] = true;
  vorderlist_columns.push_back(ORDERLIST_COL_AVG_PRICE);
  morderlist_columns[ORDERLIST_COL_APPLY_TIME] = true;
  vorderlist_columns.push_back(ORDERLIST_COL_APPLY_TIME);
  morderlist_columns[ORDERLIST_COL_UPDATE_TIME] = true;
  vorderlist_columns.push_back(ORDERLIST_COL_UPDATE_TIME);
  morderlist_columns[ORDERLIST_COL_STATUS] = true;
  vorderlist_columns.push_back(ORDERLIST_COL_STATUS);
  morderlist_columns[ORDERLIST_COL_SH_FLAG] = true;
  vorderlist_columns.push_back(ORDERLIST_COL_SH_FLAG);
  morderlist_columns[ORDERLIST_COL_ORDERID] = true;
  vorderlist_columns.push_back(ORDERLIST_COL_ORDERID);
  morderlist_columns[ORDERLIST_COL_EXCHANGE_NAME] = true;
  vorderlist_columns.push_back(ORDERLIST_COL_EXCHANGE_NAME);
  morderlist_columns[ORDERLIST_COL_DESC] = true;
  vorderlist_columns.push_back(ORDERLIST_COL_DESC);

  // Init Fill List Columns
  mfilllist_columns[FILLLIST_COL_ACC_ID] = true;
  vfilllist_columns.push_back(FILLLIST_COL_ACC_ID);
  mfilllist_columns[FILLLIST_COL_SYMBOL] = true;
  vfilllist_columns.push_back(FILLLIST_COL_SYMBOL);
  mfilllist_columns[FILLLIST_COL_SYMBOL_NAME] = true;
  vfilllist_columns.push_back(FILLLIST_COL_SYMBOL_NAME);
  mfilllist_columns[FILLLIST_COL_DIRECTION] = true;
  vfilllist_columns.push_back(FILLLIST_COL_DIRECTION);
  mfilllist_columns[FILLLIST_COL_VOLUME] = true;
  vfilllist_columns.push_back(FILLLIST_COL_VOLUME);
  mfilllist_columns[FILLLIST_COL_PRICE] = true;
  vfilllist_columns.push_back(FILLLIST_COL_PRICE);
  mfilllist_columns[FILLLIST_COL_TIME] = true;
  vfilllist_columns.push_back(FILLLIST_COL_TIME);
  mfilllist_columns[FILLLIST_COL_SH_FLAG] = true;
  vfilllist_columns.push_back(FILLLIST_COL_SH_FLAG);
  mfilllist_columns[FILLLIST_COL_ORDERID] = true;
  vfilllist_columns.push_back(FILLLIST_COL_ORDERID);
  mfilllist_columns[FILLLIST_COL_FILLID] = true;
  vfilllist_columns.push_back(FILLLIST_COL_FILLID);
  mfilllist_columns[FILLLIST_COL_EXCHANGE_NAME] = true;
  vfilllist_columns.push_back(FILLLIST_COL_EXCHANGE_NAME);

  // Init Position List Columns
  mpositionlist_columns[POSITIONLIST_COL_ACC_ID] = true;
  vpositionlist_columns.push_back(POSITIONLIST_COL_ACC_ID);
  mpositionlist_columns[POSITIONLIST_COL_SYMBOL] = true;
  vpositionlist_columns.push_back(POSITIONLIST_COL_SYMBOL);
  mpositionlist_columns[POSITIONLIST_COL_SYMBOL_NAME] = true;
  vpositionlist_columns.push_back(POSITIONLIST_COL_SYMBOL_NAME);
  mpositionlist_columns[POSITIONLIST_COL_VOLUME] = true;
  vpositionlist_columns.push_back(POSITIONLIST_COL_VOLUME);
  mpositionlist_columns[POSITIONLIST_COL_AVG_PRICE] = true;
  vpositionlist_columns.push_back(POSITIONLIST_COL_AVG_PRICE);
  mpositionlist_columns[POSITIONLIST_COL_PROFITLOSS] = true;
  vpositionlist_columns.push_back(POSITIONLIST_COL_PROFITLOSS);
  mpositionlist_columns[POSITIONLIST_COL_MARGIN] = true;
  vpositionlist_columns.push_back(POSITIONLIST_COL_MARGIN);
  mpositionlist_columns[POSITIONLIST_COL_AMOUNT] = true;
  vpositionlist_columns.push_back(POSITIONLIST_COL_AMOUNT);
  mpositionlist_columns[POSITIONLIST_COL_BUY_VOLUME] = true;
  vpositionlist_columns.push_back(POSITIONLIST_COL_BUY_VOLUME);
  mpositionlist_columns[POSITIONLIST_COL_BUY_PRICE] = true;
  vpositionlist_columns.push_back(POSITIONLIST_COL_BUY_PRICE);
  mpositionlist_columns[POSITIONLIST_COL_BUY_PROFITLOSS] = true;
  vpositionlist_columns.push_back(POSITIONLIST_COL_BUY_PROFITLOSS);
  mpositionlist_columns[POSITIONLIST_COL_BUY_TODAY] = true;
  vpositionlist_columns.push_back(POSITIONLIST_COL_BUY_TODAY);
  mpositionlist_columns[POSITIONLIST_COL_SELL_VOLUME] = true;
  vpositionlist_columns.push_back(POSITIONLIST_COL_SELL_VOLUME);
  mpositionlist_columns[POSITIONLIST_COL_SELL_PRICE] = true;
  vpositionlist_columns.push_back(POSITIONLIST_COL_SELL_PRICE);
  mpositionlist_columns[POSITIONLIST_COL_SELL_PROFITLOSS] = true;
  vpositionlist_columns.push_back(POSITIONLIST_COL_SELL_PROFITLOSS);
  mpositionlist_columns[POSITIONLIST_COL_SELL_TODAY] = true;
  vpositionlist_columns.push_back(POSITIONLIST_COL_SELL_TODAY);
  mpositionlist_columns[POSITIONLIST_COL_EXCHANGE_NAME] = true;
  vpositionlist_columns.push_back(POSITIONLIST_COL_EXCHANGE_NAME);

  // Init Account List Columns
  macclist_columns[ACCLIST_COL_ACC_ID] = true;
  vacclist_columns.push_back(ACCLIST_COL_ACC_ID);
  macclist_columns[ACCLIST_COL_ACC_NAME] = true;
  vacclist_columns.push_back(ACCLIST_COL_ACC_NAME);
  macclist_columns[ACCLIST_COL_PRE_BALANCE] = true;
  vacclist_columns.push_back(ACCLIST_COL_PRE_BALANCE);
  macclist_columns[ACCLIST_COL_MONEY_IN] = true;
  vacclist_columns.push_back(ACCLIST_COL_MONEY_IN);
  macclist_columns[ACCLIST_COL_MONEY_OUT] = true;
  vacclist_columns.push_back(ACCLIST_COL_MONEY_OUT);
  macclist_columns[ACCLIST_COL_FROZEN_MARGIN] = true;
  vacclist_columns.push_back(ACCLIST_COL_FROZEN_MARGIN);
  macclist_columns[ACCLIST_COL_MONEY_FROZEN] = true;
  vacclist_columns.push_back(ACCLIST_COL_MONEY_FROZEN);
  macclist_columns[ACCLIST_COL_FEE_FROZEN] = true;
  vacclist_columns.push_back(ACCLIST_COL_FEE_FROZEN);
  macclist_columns[ACCLIST_COL_MARGIN] = true;
  vacclist_columns.push_back(ACCLIST_COL_MARGIN);
  macclist_columns[ACCLIST_COL_FEE] = true;
  vacclist_columns.push_back(ACCLIST_COL_FEE);
  macclist_columns[ACCLIST_COL_CLOSE_PROFIT_LOSS] = true;
  vacclist_columns.push_back(ACCLIST_COL_CLOSE_PROFIT_LOSS);
  macclist_columns[ACCLIST_COL_FLOAT_PROFIT_LOSS] = true;
  vacclist_columns.push_back(ACCLIST_COL_FLOAT_PROFIT_LOSS);
  macclist_columns[ACCLIST_COL_BALANCE_AVAILABLE] = true;
  vacclist_columns.push_back(ACCLIST_COL_BALANCE_AVAILABLE);
  macclist_columns[ACCLIST_COL_BROKER_ID] = true;
  vacclist_columns.push_back(ACCLIST_COL_BROKER_ID);
